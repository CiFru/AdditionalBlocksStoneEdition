...
//
    public static void onFeatureRegistry(final RegistryEvent.Register<Feature<?>> e){
        ore_marble = Feature.ORE.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.BASE_STONE_OVERWORLD, AdditionalBlocks.marble.getDefaultState(), 20)).withPlacement(Placement.RANGE.configure(new TopSolidRangeConfig(0, 64, 100)));
