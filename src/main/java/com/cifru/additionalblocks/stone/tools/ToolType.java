...
public enum ToolType {
    ...
    private final Tag.Named<Block> mineableTag;
    private final Set<ToolAction> toolActions;
    private final float baseAttackDamage;
    private final float baseAttackSpeed;

    ToolType(Tag.Named<Block> mineableTag, Set<ToolAction> toolActions, float baseAttackDamage, float baseAttackSpeed){
    ...
    public Tag.Named<Block> getMineableTag(){
