...
public class AbBlockStateProvider extends BlockStateProvider {
    ...
    private void addStoneStairsModels() {
        ...
        this.stairsBlock(AdditionalBlocks.glowstone_stairs, "glowstone", new ResourceLocation("abstoneedition", "glowstone"));
        ...
        this.stairsBlock(AdditionalBlocks.smooth_stone_stairs, "smooth_stone", new ResourceLocation("abstoneedition", "smooth_stone"));
    ...
    private void addStoneSlabModels() {
        ...
        this.slabBlock(AdditionalBlocks.glowstone_slab, new ResourceLocation("abstoneedition", "block/glowstone"), new ResourceLocation("abstoneedition", "glowstone"));
