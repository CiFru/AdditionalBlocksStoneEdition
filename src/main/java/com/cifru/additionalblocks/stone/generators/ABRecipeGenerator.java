...
public class ABRecipeGenerator extends RecipeGenerator {
    ...
    public void manualRecipes(){
        ...
        this.shaped(AdditionalBlocksBlocks.STONE_TILES, 4)
            ...
            .condition(new BlockEnabledResourceCondition(AdditionalBlocksBlocks.SMOOTH_STONE_BRICKS));
        // Sunstone
        Tag<Item> copperIngots = ItemTags.createOptional(new ResourceLocation("forge", "ingots/copper"));
        ...
        this.shaped(Items.COPPER_INGOT)
            ...
            .unlockedBy(Items.COPPER_INGOT, AdditionalBlocksItems.COPPER_NUGGET)
            .condition(new ItemEnabledResourceCondition(AdditionalBlocksItems.COPPER_NUGGET));
        ...
        // Silver ingots
        Tag<Item> silverIngots = ItemTags.createOptional(new ResourceLocation("forge", "ingots/silver"));
        ...
        // Bismuth ingots
        Tag<Item> bismuthIngots = ItemTags.createOptional(new ResourceLocation("forge", "ingots/bismuth"));
    ...
    public static abstract class SingleIngredientBlockPreset {
        ...
        public BlockPreset from(Supplier<ItemLike> item){
