...
public class ABBlockStateGenerator extends BlockStateGenerator {
    ...
    public static final BlockPreset WALL = (generator, blockType) -> {
        ...
        generator.blockState(blockType.getBlock())
            ...
            .multipart(condition -> condition.requireProperty(ABBlockProperties.WALL_NORTH, WallHeight.LOW), variant -> variant.model(namespace, "block/" + identifier + "_side", 0, ((int)Direction.NORTH.toYRot() + 180) % 360, true))
            .multipart(condition -> condition.requireProperty(ABBlockProperties.WALL_EAST, WallHeight.LOW), variant -> variant.model(namespace, "block/" + identifier + "_side", 0, ((int)Direction.EAST.toYRot() + 180) % 360, true))
            .multipart(condition -> condition.requireProperty(ABBlockProperties.WALL_SOUTH, WallHeight.LOW), variant -> variant.model(namespace, "block/" + identifier + "_side", 0, ((int)Direction.SOUTH.toYRot() + 180) % 360, true))
            .multipart(condition -> condition.requireProperty(ABBlockProperties.WALL_WEST, WallHeight.LOW), variant -> variant.model(namespace, "block/" + identifier + "_side", 0, ((int)Direction.WEST.toYRot() + 180) % 360, true))
            .multipart(condition -> condition.requireProperty(ABBlockProperties.WALL_NORTH, WallHeight.TALL), variant -> variant.model(namespace, "block/" + identifier + "_side_tall", 0, ((int)Direction.NORTH.toYRot() + 180) % 360, true))
            .multipart(condition -> condition.requireProperty(ABBlockProperties.WALL_EAST, WallHeight.TALL), variant -> variant.model(namespace, "block/" + identifier + "_side_tall", 0, ((int)Direction.EAST.toYRot() + 180) % 360, true))
            .multipart(condition -> condition.requireProperty(ABBlockProperties.WALL_SOUTH, WallHeight.TALL), variant -> variant.model(namespace, "block/" + identifier + "_side_tall", 0, ((int)Direction.SOUTH.toYRot() + 180) % 360, true))
            .multipart(condition -> condition.requireProperty(ABBlockProperties.WALL_WEST, WallHeight.TALL), variant -> variant.model(namespace, "block/" + identifier + "_side_tall", 0, ((int)Direction.WEST.toYRot() + 180) % 360, true));
    };
