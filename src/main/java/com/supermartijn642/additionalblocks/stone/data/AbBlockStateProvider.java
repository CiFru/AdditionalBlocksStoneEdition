...
public class AbBlockStateProvider extends BlockStateProvider {
    ...
    private void addStoneStairsModels() {
        ...
        this.models().withExistingParent("item/brown_stone_path_straight_stairs", new ResourceLocation("abstoneedition", "block/brown_stone_path_straight_stairs"));
        this.models().withExistingParent("item/brown_stone_path_curved_stairs", new ResourceLocation("abstoneedition", "block/brown_stone_path_curved_stairs"));
        this.models().withExistingParent("item/brown_stone_pattern_stairs", new ResourceLocation("abstoneedition", "block/brown_stone_pattern_stairs"));
        this.models().withExistingParent("item/brown_stone_tiles_stairs", new ResourceLocation("abstoneedition", "block/brown_stone_tiles_stairs"));
        this.models().withExistingParent("item/old_stone_path_straight_stairs", new ResourceLocation("abstoneedition", "block/old_stone_path_straight_stairs"));
        this.models().withExistingParent("item/old_stone_path_curved_stairs", new ResourceLocation("abstoneedition", "block/old_stone_path_curved_stairs"));
        this.models().withExistingParent("item/old_stone_pattern_stairs", new ResourceLocation("abstoneedition", "block/old_stone_pattern_stairs"));
        this.models().withExistingParent("item/old_stone_tiles_stairs", new ResourceLocation("abstoneedition", "block/old_stone_tiles_stairs"));
        this.models().withExistingParent("item/stone_path_straight_stairs", new ResourceLocation("abstoneedition", "block/stone_path_straight_stairs"));
        this.models().withExistingParent("item/stone_path_curved_stairs", new ResourceLocation("abstoneedition", "block/stone_path_curved_stairs"));
        this.models().withExistingParent("item/stone_pattern_stairs", new ResourceLocation("abstoneedition", "block/stone_pattern_stairs"));
        this.models().withExistingParent("item/stone_tiles_stairs", new ResourceLocation("abstoneedition", "block/stone_tiles_stairs"));
        this.models().withExistingParent("item/glowstone_stairs", new ResourceLocation("abstoneedition", "block/glowstone_stairs"));
        this.models().withExistingParent("item/limestone_bricks_stairs", new ResourceLocation("abstoneedition", "block/limestone_bricks_stairs"));
        this.models().withExistingParent("item/smooth_limestone_stairs", new ResourceLocation("abstoneedition", "block/smooth_limestone_stairs"));
        this.models().withExistingParent("item/smooth_stone_stairs", new ResourceLocation("abstoneedition", "block/smooth_stone_stairs"));
        this.models().withExistingParent("item/smooth_smooth_stone_stairs", new ResourceLocation("abstoneedition", "block/smooth_smooth_stone_stairs"));
        this.models().withExistingParent("item/obsidian_stairs", new ResourceLocation("abstoneedition", "block/obsidian_stairs"));
        this.models().withExistingParent("item/obsidian_bricks_stairs", new ResourceLocation("abstoneedition", "block/obsidian_bricks_stairs"));
    }
    ...
    private void addStoneSlabModels() {
        ...
        this.models().withExistingParent("item/brown_stone_path_straight_slab", new ResourceLocation("abstoneedition", "block/brown_stone_path_straight_slab"));
        this.models().withExistingParent("item/brown_stone_path_curved_slab", new ResourceLocation("abstoneedition", "block/brown_stone_path_curved_slab"));
        this.models().withExistingParent("item/brown_stone_pattern_slab", new ResourceLocation("abstoneedition", "block/brown_stone_pattern_slab"));
        this.models().withExistingParent("item/brown_stone_tiles_slab", new ResourceLocation("abstoneedition", "block/brown_stone_tiles_slab"));
        this.models().withExistingParent("item/old_stone_path_straight_slab", new ResourceLocation("abstoneedition", "block/old_stone_path_straight_slab"));
        this.models().withExistingParent("item/old_stone_path_curved_slab", new ResourceLocation("abstoneedition", "block/old_stone_path_curved_slab"));
        this.models().withExistingParent("item/old_stone_pattern_slab", new ResourceLocation("abstoneedition", "block/old_stone_pattern_slab"));
        this.models().withExistingParent("item/old_stone_tiles_slab", new ResourceLocation("abstoneedition", "block/old_stone_tiles_slab"));
        this.models().withExistingParent("item/stone_path_straight_slab", new ResourceLocation("abstoneedition", "block/stone_path_straight_slab"));
        this.models().withExistingParent("item/stone_path_curved_slab", new ResourceLocation("abstoneedition", "block/stone_path_curved_slab"));
        this.models().withExistingParent("item/stone_pattern_slab", new ResourceLocation("abstoneedition", "block/stone_pattern_slab"));
        this.models().withExistingParent("item/stone_tiles_slab", new ResourceLocation("abstoneedition", "block/stone_tiles_slab"));
        this.models().withExistingParent("item/glowstone_slab", new ResourceLocation("abstoneedition", "block/glowstone_slab"));
        this.models().withExistingParent("item/limestone_bricks_slab", new ResourceLocation("abstoneedition", "block/limestone_bricks_slab"));
        this.models().withExistingParent("item/smooth_limestone_slab", new ResourceLocation("abstoneedition", "block/smooth_limestone_slab"));
        this.models().withExistingParent("item/smooth_smooth_stone_slab", new ResourceLocation("abstoneedition", "block/smooth_smooth_stone_slab"));
        this.models().withExistingParent("item/obsidian_slab", new ResourceLocation("abstoneedition", "block/obsidian_slab"));
        this.models().withExistingParent("item/obsidian_bricks_slab", new ResourceLocation("abstoneedition", "block/obsidian_bricks_slab"));
    }
