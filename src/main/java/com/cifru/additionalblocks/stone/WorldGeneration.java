...
public class WorldGeneration {
    ...
    public static void onFeatureRegistry(final RegistryEvent.Register<Feature<?>> e){
        ...
        ConfiguredFeature<?,?> silverFeature = new ConfiguredFeature<>(Feature.ORE, new OreConfiguration(OreFeatures.NATURAL_STONE, AdditionalBlocksBlocks.SILVER_ORE.getBlock().defaultBlockState(), 6));
        ...
        ConfiguredFeature<?,?> volcanicStoneBricksFeature = new ConfiguredFeature<>(Feature.ORE, new OreConfiguration(OreFeatures.NATURAL_STONE, AdditionalBlocksBlocks.VOLCANIC_STONE_BRICKS.getBlock().defaultBlockState(), 30));
        ...
        ConfiguredFeature<?,?> bismuthFeature = new ConfiguredFeature<>(Feature.ORE, new OreConfiguration(OreFeatures.NATURAL_STONE, AdditionalBlocksBlocks.BISMUTH_ORE.getBlock().defaultBlockState(), 4));
