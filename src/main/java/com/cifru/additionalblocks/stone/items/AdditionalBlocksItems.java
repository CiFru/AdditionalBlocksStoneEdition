...
public class AdditionalBlocksItems {
    ...
    // ---- Items ----
    // Copper
    public static final ItemType<BaseItem> COPPER_INGOT = ItemBuilder.create("copper_ingot").translation("Copper Ingot").configOption(AdditionalBlocksConfig.enableCopper).tag("forge","ingots").tag("forge","ingots/copper").buildRegular(COLLECTOR);
