...
public class WorldGeneration {
    ...
    public static void onFeatureRegistry(final RegistryEvent.Register<Feature<?>> e) {
        ore_marble = Feature.ORE.configured(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.NATURAL_STONE, AdditionalBlocks.marble.defaultBlockState(), 25));
        ore_marble = ore_marble.range(60).squared().count(6);
        Registry.register(WorldGenRegistries.CONFIGURED_FEATURE,
                new ResourceLocation("abstoneedition", "ore_marble"),
                ore_marble
        );
        ore_limestone = Feature.ORE.configured(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.NATURAL_STONE, AdditionalBlocks.limestone.defaultBlockState(), 25));
        ore_limestone = ore_limestone.range(60).squared().count(6);
        Registry.register(WorldGenRegistries.CONFIGURED_FEATURE,
                new ResourceLocation("abstoneedition", "ore_limestone"),
                ore_limestone
        );
        ore_copper = Feature.ORE.configured(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.NATURAL_STONE, AdditionalBlocks.copper_ore.defaultBlockState(), 10));
        ore_copper = ore_copper.range(64).squared().count(20);
        Registry.register(WorldGenRegistries.CONFIGURED_FEATURE,
                new ResourceLocation("abstoneedition", "ore_copper"),
                ore_copper
        );
        ore_silver = Feature.ORE.configured(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.NATURAL_STONE, AdditionalBlocks.silver_ore.defaultBlockState(), 9));
        ...
        ore_black_marble = Feature.ORE.configured(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.NETHER_ORE_REPLACEABLES, AdditionalBlocks.black_marble.defaultBlockState(), 25));
        ore_black_marble = ore_black_marble.range(60).squared().count(6);
        Registry.register(WorldGenRegistries.CONFIGURED_FEATURE,
                new ResourceLocation("abstoneedition", "ore_black_marble"),
                ore_black_marble
        );
        ore_volcanic_stone_bricks = Feature.ORE.configured(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.NETHER_ORE_REPLACEABLES, AdditionalBlocks.volcanic_stone_bricks.defaultBlockState(), 25));
        ...
        ore_volcanic_stone = Feature.ORE.configured(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.NATURAL_STONE, AdditionalBlocks.volcanic_stone.defaultBlockState(), 30));
