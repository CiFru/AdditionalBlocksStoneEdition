 ...
 */
public class ABPickaxeItem extends ABToolItem {

    public ABPickaxeItem(ItemProperties properties, Supplier<Boolean> enabled, ABToolMaterial toolMaterial){
        super(properties, enabled, toolMaterial, ToolType.PICKAXE);
    }
}
