...
public class AbRecipeProvider extends RecipeProvider {
    ...
    private void addStairsRecipe(Consumer<FinishedRecipe> recipeConsumer, StairBlock stairBlock, Block block){
    ...
    private void addWallsRecipe(Consumer<FinishedRecipe> recipeConsumer, WallBlock wallBlock, Block block){
    ...
    private void addStoneStairsRecipes(Consumer<FinishedRecipe> recipeConsumer){
